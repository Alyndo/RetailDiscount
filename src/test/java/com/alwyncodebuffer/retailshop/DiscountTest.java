...
import com.alwyncodebuffer.retailshop.models.*;
import com.alwyncodebuffer.retailshop.services.DiscountService;
import com.alwyncodebuffer.retailshop.services.DiscountServiceImpl;
...
public class DiscountTest {
    ...
    private void assertEquals(double v, double doubleValue, int i) {
    }
    ...
    private void assertFalse(boolean isTwoYearsJoined) {
    }
    ...
    private void assertTrue(boolean isTwoYearsJoined) {
    }
